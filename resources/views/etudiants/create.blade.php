        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">
                    Ajoutez un nouvel étudiant au système.
                </p>
            </div>

            <div class="glass rounded-2xl border border-gray-200 dark:border-gray-700/50 p-6 sm:p-8">
                <form method="POST" action="{{ route('etudiants.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="CodeE" name="CodeE" type="text" class="mt-1 block w-full"
                            :value="old('CodeE')" required autofocus placeholder="Ex: E2026001" />
                    ...
                    <div>
                        ...
                        <x-text-input id="email" name="email" type="email" class="mt-1 block w-full"
                            :value="old('email')" required placeholder="Ex: jean.dupont@example.com" />
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <x-primary-button>{{ __('Créer l\'étudiant') }}</x-primary-button>
                    </div>
                </form>
            </div>
        </div>
