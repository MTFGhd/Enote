            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-1">
                        Gestion des matières et modules d'enseignement.
                    </p>
                </div>
                        ...
                        <table class="min-w-full text-sm">
                            <thead>
                                <tr class="text-left border-b border-gray-200 dark:border-gray-700">
                                    ...
                                    <th class="py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Heures</th>
                                    <th class="py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Coef</th>
                                ...
                                @forelse ($matieres as $matiere)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                        <td class="py-4 px-4 font-medium text-gray-900 dark:text-white">
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-lg bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 font-mono">
                                                {{ $matiere->CodeM }}
                                            </span>
                                        </td>
                                        <td class="py-4 px-4 text-gray-600 dark:text-gray-300">{{ $matiere->Libelle }}</td>
                                        ...
                                        <td class="py-4 px-4 text-gray-600 dark:text-gray-300">
                                            <span
                                                class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-xs font-bold">
                                                {{ $matiere->Coef }}
                                            </span>
                                        </td>
                                        <td class="py-4 px-4">
                                            <div class="flex items-center gap-2">
                                                ...
                                                @if ($matiere->departement?->Libelle)
                                                    <span
                                                        class="text-xs text-gray-500 dark:text-gray-400">{{ $matiere->departement->Libelle }}</span>
                                                @endif
                                            </div>
                                        </td>
