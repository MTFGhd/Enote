        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="glass rounded-2xl border border-gray-200 dark:border-gray-700/50 overflow-hidden">
                <div class="p-6">
                    ...
                    @if (session('error'))
                        <div
                            class="mb-6 p-4 rounded-xl bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 border border-red-100 dark:border-red-800 flex items-center gap-3">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                            ...
                            <tr class="text-left border-b border-gray-200 dark:border-gray-700">
                                <th class="py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Nom</th>
                                <th class="py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Email</th>
                                <th class="py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Rôle</th>
                                <th class="py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">CodeE</th>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                    ...
                                    <td class="py-4 px-4">
                                        @php
                                            $role = $user->role;
                                            $roleLabels = [
                                                'admin' => ['label' => 'Administrateur', 'bg' => 'bg-primary-50 dark:bg-primary-900/30', 'text' => 'text-primary-700 dark:text-primary-300'],
                                                'E' => ['label' => 'Enseignant', 'bg' => 'bg-blue-50 dark:bg-blue-900/30', 'text' => 'text-blue-700 dark:text-blue-300'],
                                                'D' => ['label' => 'Direction', 'bg' => 'bg-emerald-50 dark:bg-emerald-900/30', 'text' => 'text-emerald-700 dark:text-emerald-300'],
                                            ];
                                        ...
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold {{ $style['bg'] }} {{ $style['text'] }}">
                                            <span class="w-2 h-2 rounded-full mr-2
                                                @if($role === 'admin') bg-primary-500
                                                @elseif($role === 'E') bg-blue-500
                                    ...
                                    <td class="py-4 px-4 text-gray-600 dark:text-gray-300">
                                        @if($user->role === 'E')
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-mono">
                                                {{ $user->CodeE ?? '—' }}
                                            </span>
                                        @else
                            ...
                            @empty
                                <tr>
                                    <td class="py-8 text-center text-gray-500 dark:text-gray-400" colspan="5">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <a href="{{ route('users.create') }}"
                                               class="mt-2 text-primary-600 hover:text-primary-500 font-medium">
