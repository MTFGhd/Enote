        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="glass rounded-2xl border border-gray-200 dark:border-gray-700/50 p-6 sm:p-8">
                <form method="POST" action="{{ route('users.update', $user) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="CodeE" name="CodeE"
                                ...
                                @foreach($enseignants as $enseignant)
                                    <option value="{{ $enseignant->CodeE }}" {{ old('CodeE', $user->CodeE) === $enseignant->CodeE ? 'selected' : '' }}>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <x-input-label for="password" :value="__('Nouveau mot de passe (optionnel)')" class="text-gray-700 dark:text-gray-300 font-medium mb-1"/>
                            <x-text-input id="password" name="password" type="password" class="mt-1 block w-full"
                                          autocomplete="new-password" placeholder="Laisser vide pour conserver l'actuel"/>
