                                ...
                                @forelse ($departements as $departement)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                        <td class="py-4 px-4 font-medium text-gray-900 dark:text-white">
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-mono">
                                                {{ $departement->CodeD }}
                                            </span>
                                        </td>
                                        <td class="py-4 px-4 text-gray-600 dark:text-gray-300">{{ $departement->Libelle }}
                                        </td>
