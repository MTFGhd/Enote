        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">
                    Créez un nouveau département académique.
                </p>
            </div>
            ...
            <div class="glass rounded-2xl border border-gray-200 dark:border-gray-700/50 p-6 sm:p-8">
                <form method="POST" action="{{ route('departements.store') }}" class="space-y-6">
                    ...
                    <div>
                        <x-input-label for="CodeD" :value="__('Code département')"
                            class="text-gray-700 dark:text-gray-300 font-medium mb-1" />
                        <x-text-input id="CodeD" name="CodeD" type="text" class="mt-1 block w-full"
                            :value="old('CodeD')" required autofocus placeholder="Ex: INFO" />
                    ...
                    <div>
                        ...
                        <x-text-input id="Libelle" name="Libelle" type="text" class="mt-1 block w-full"
                            :value="old('Libelle')" required placeholder="Ex: Informatique" />
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <x-primary-button>{{ __('Créer le département') }}</x-primary-button>
                    </div>
                </form>
            </div>
        </div>
