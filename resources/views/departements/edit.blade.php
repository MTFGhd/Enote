    ...
    <div class="py-12 relative z-10">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="glass rounded-2xl border border-gray-200 dark:border-gray-700/50 p-6 sm:p-8">
                <form method="POST" action="{{ route('departements.update', $departement) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <x-text-input id="CodeD" type="text"
                            class="mt-1 block w-full bg-gray-50 dark:bg-gray-800 text-gray-500 cursor-not-allowed"
                            :value="$departement->CodeD" disabled />
                        <p class="mt-1 text-xs text-gray-500">Le code département ne peut pas être modifié.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <x-text-input id="Libelle" name="Libelle" type="text" class="mt-1 block w-full"
                            :value="old('Libelle', $departement->Libelle)" required />
