        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">
                    Informations complètes sur l'enseignant.
                </p>
            </div>
            ...
            <div class="glass rounded-2xl border border-gray-200 dark:border-gray-700/50 p-6 sm:p-8">
                <div class="flex flex-col md:flex-row md:items-start gap-8">
                    <div class="flex-shrink-0">
                        <div
                            class="w-20 h-20 rounded-2xl bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center text-white font-bold text-3xl shadow-lg shadow-orange-500/30">
                    ...
                    <div class="flex-grow grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <div class="text-lg font-semibold text-gray-900 dark:text-white">{{ $enseignant->CodeE }}
                            </div>
                        </div>

                        <div>
                            <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Nom Complet</div>
                            <div class="text-lg font-semibold text-gray-900 dark:text-white">{{ $enseignant->Libelle }}
                            </div>
                        </div>

                        <div>
                            <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Séances dispensées
                            </div>
                            <div class="text-lg font-semibold text-gray-900 dark:text-white">
                                {{ $enseignant->cours?->count() ?? 0 }}</div>
                        </div>

                        <div>
                            <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Dernière activité
                            </div>
                            <div class="text-lg font-semibold text-gray-900 dark:text-white">
                                {{ $enseignant->cours?->last()?->Jour ? \Illuminate\Support\Carbon::parse($enseignant->cours->last()->Jour)->format('d/m/Y') : 'Aucune' }}
                            </div>
                        </div>
                    </div>
                </div>
