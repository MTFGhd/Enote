    ...
    <div class="py-12 relative z-10">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="glass rounded-2xl border border-gray-200 dark:border-gray-700/50 p-6 sm:p-8">
                <form method="POST" action="{{ route('enseignants.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="CodeE" name="CodeE" type="text" class="mt-1 block w-full"
                            :value="old('CodeE')" required autofocus placeholder="Ex: JD001" />
                    ...
                    <div>
                        ...
                        <x-text-input id="Libelle" name="Libelle" type="text" class="mt-1 block w-full"
                            :value="old('Libelle')" required placeholder="Ex: Jean Dupont" />
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <x-primary-button>{{ __('Créer l\'enseignant') }}</x-primary-button>
                    </div>
                </form>
            </div>
        </div>
